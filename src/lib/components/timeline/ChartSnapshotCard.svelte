...
<div class="mb-2 ml-8">
	<!-- Timeline dot -->
	<div class="absolute left-0 flex h-3.5 w-3.5 items-center justify-center rounded-full bg-indigo-500 ring-2 ring-background mt-1.5"></div>
	...
	<div class="py-1.5">
		...
		>
			...
			<span class="text-sm font-semibold text-foreground group-hover:text-indigo-600 transition-colors">{i18n.t.timeline.snapshot.title}</span>
